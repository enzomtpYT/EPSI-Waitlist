...
def copy_schema(target_schema, source_schema="public"):
    ...
    cur.execute(f"DROP TABLE IF EXISTS {target_schema}.\"User\" CASCADE;")
    cur.execute(f"DROP TABLE IF EXISTS {target_schema}.\"permission\" CASCADE;")
    cur.execute(f"DROP TABLE IF EXISTS {target_schema}.\"role\" CASCADE;")
    cur.execute(f"DROP TABLE IF EXISTS {target_schema}.\"user_role\" CASCADE;")
    cur.execute(f"DROP TABLE IF EXISTS {target_schema}.\"role_permission\" CASCADE;")
